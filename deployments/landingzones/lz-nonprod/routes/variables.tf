...
variable "subscription_id" {
  type        = string
  description = "Non-prod landing zone subscription ID (injected later via pipeline)"
}
...
variable "key_spoke_vnet" {
  type        = string
  description = "State key for non-prod VNet deployment"
